 ...
 */
public interface DomainCreateOrderInputPort {
     ...
     *         - Communication error
     * @throws DomainExceptionPaymentFailed if payment is declined:
     *         - Insufficient funds
     *         - Card declined
     *         - Payment method invalid
     */
    DomainOrderEntity execute(DomainOrderEntity order) throws 
        DomainExceptionInvalidOrder,
        DomainInventoryException,
        DomainPaymentException,
        DomainExceptionPaymentFailed;
}
